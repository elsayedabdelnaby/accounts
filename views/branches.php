                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <i class="fa fa-angle-right">الافرع</i>
                            </li>
                            <li>
                                <span></span>
                            </li>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold">أضافة فرع جديد</span>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <form method="POST" action="<?= URL ?>branches" accept-charset="UTF-8" role="form" novalidate="novalidate">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>الافرع</div>
                                    <div class="tools"> </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($branches) {
                                                foreach ($branches as $branch) {
                                                    ?>
                                                    <tr>
                                                        <td><a href="<?= URL ?>branches/<?= $branch['id'] ?>"><?= $branch['name'] ?> </a></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
