                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold">  اذن دخل</span>
                                    </div>
                                    <br>
                                    <div class="caption font-green">
                                ...
                                <div class="portlet-body form">
                                    <form method="POST" action="<?= URL ?>entrances" accept-charset="UTF-8" role="form" novalidate="novalidate">
                                        <div class="form-body row">
                                            <div class="col-md-1"></div>
                                            <div class="form-group form-md-line-input form-md-floating-label col-md-4">
                                                <select name='who' class='form-control' id='whoList' required="required">
                                                    <option value='0'>أختر</option>
                                                    <option value='5'>الطلابة</option>
                                        ...
                                        <div class="form-body row" id="coursesDiv">
                                            <div class="col-md-1"></div>
                                            <div class="form-group form-md-line-input form-md-floating-label col-md-4">
                                                <select name='courses' class='form-control' id='coursesList' required="required" id="coursesList">
                                                    <option value='0'>أختر</option>
                                                    <?php
                                                    foreach ($courses as $course) {
                                                        ?>
                                                        <option value="<?= $course['id'] ?>"<?php if (@$_POST['courses'] == $course['id']) { ?>selected<?php } ?>><?= $course['name'].' - '.$course['price'] ?></option>
                                                        <?php
                                                    }
                                                    ?>
                                                </select>
                                                <span id="delivery-error" class="help-block help-block-error"></span>
                                                <label for="form_control_1">الكورسات</label>
                                            </div>
                                            <div class="col-md-1"></div>
                                            <div class="form-group form-md-line-input form-md-floating-label col-md-4">
                                                <select name='paymentmethods' class='form-control' id='paymentmethodsList' required="required">
                                                    <option value='0'>أختر</option>
                                                    <?php
                                        ...
                                        <div class="form-body row">
                                            ...
                                            <div class="col-md-1"></div>
                                            <div class="form-group form-md-line-input form-md-floating-label col-md-4">
                                                <select name='branches' class='form-control' id='branchesList' required="required">
                                                    <option value='0'>أختر</option>
                                                    <?php
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>الدخل</div>
                                    <div class="tools"> </div>
                                </div>
