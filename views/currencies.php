                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                ...
                                <i class="fa fa-angle-right">العملات</i>
                            </li>
                            <li>
                                <span></span>
                            </li>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold">أضافة عملة جديد</span>
                                    </div>
                                </div>
                                <div class="portlet-body form">
                                    <form method="POST" action="<?= URL ?>currencies" accept-charset="UTF-8" role="form" novalidate="novalidate">
                    ...
                    <?php } elseif ($form_type == 'update') { ?>
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption font-green">
                                    <i class="icon-pin font-green"></i>
                                    <span class="caption-subject bold">تعديل بيانات العملة</span>
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <form method="POST" action="<?= URL ?>currencies/<?= $row['id'] ?>" accept-charset="UTF-8" role="form" novalidate="novalidate">
                                    <div class="form-body row">
                                        <div class="col-md-1"></div>
                                        <div class="form-group form-md-line-input form-md-floating-label col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>العملات</div>
                                    <div class="tools"> </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($currencies) {
                                                foreach ($currencies as $currency) {
                                                    ?>
                                                    <tr>
                                                        <td><a href="<?= URL ?>currencies/<?= $currency['id'] ?>"><?= $currency['name'] ?> </a></td>
                                                    </tr>
                                                    <?php
                                                }
                                            }
